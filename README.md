...
Full-stack developer with several years of professional experience shipping production web applications end-to-end, from data modeling to polished front ends. Comfortable across the modern JavaScript/TypeScript ecosystem, and increasingly working with no-code/low-code platforms to deliver client projects faster.
